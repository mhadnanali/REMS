            ...
            for CRITERION in CRITERIONs:
                if d == 0 and CRITERION == 'gini':
                    ...
                    for i in range(20):
                        ...
                        outputFile = "DataAnalysis/RF_Analysis.csv"
                        ...
                        if os.path.isfile(outputFile):
                            ...
                            resultsDF = pd.DataFrame(
                                columns=['Algo', 'Kernal', 'depthORk', 'TrainSize', 'TestSize', 'NotDeleted', 'Deleted',
                                         ...
                                         'F1_SCORE', 'Accuracy', 'JaccardScore', 'PRECISION', 'RECALL', '0,0', '0,1',
                                         '1,0', '1,1'])
                        values_to_add = {'Algo': 'RandomForest', 'Kernal': CRITERION, 'depthORk': MAX_DEPTH,
